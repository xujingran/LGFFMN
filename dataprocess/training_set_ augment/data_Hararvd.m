...
% savePath=['E:/fusion_project/dataset/Harvard/',data_type,'/',num2str(upscale_factor),'/'];
savePath=['H:/fusion_project/dataset/Harvard/Hararvd_x2/val/'];
...
srPath =  'H:/fusion_project/dataset/Harvard/Hararvdori/valori/';
