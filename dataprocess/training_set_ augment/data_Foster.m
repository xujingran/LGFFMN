...
% savePath=['E:/fusion_project/dataset/Foster/',data_type,'/',num2str(upscale_factor),'/'];
savePath=['H:/fusion_project/dataset/Foster/Foster_x2/val/'];
...
src_path =  'H:/fusion_project/dataset/Foster/Fosterori/valori/';
