...
% savePath=['H:/fusion_project/dataset/CAVE/cave_x2', data_type,'/',num2str(upscale_factor),'/'];
savePath=['H:/fusion_project/dataset/CAVE/cave_x4/train/'];
...
% srPath = 'E:/fusion_project/dataset/CAVE/train/balloons_ms';  %source data downlaoded from website 
% srPath = 'E:/fusion_project/dataset/CAVE/train';  %source data downlaoded from website 
srPath = 'H:/fusion_project/dataset/CAVE/CAVEori/trainori/';  %source data downlaoded from website 
