...
folder_path = "H:\fusion_project\dataset\dataprocess\matlab_code\Chikusei\test";
factor = 0.125;
img_size = 512;
bands = 128;
% save_dir = "/Data/Chikusei/test_dataset_x8/";
save_dir = "H:\fusion_project\dataset\dataprocess\matlab_code\Chikusei\test\test_dataset_x8\";
