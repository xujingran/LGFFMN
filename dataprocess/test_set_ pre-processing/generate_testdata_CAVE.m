...
% savePath = ['E:/fusion_project/dataset/CAVE/CAVE/test',num2str(upscale)];  % save test set  to "savePath"
savePath = ['H:/fusion_project/dataset/CAVE/cave_x4/test'];  % save test set  to "savePath"
...
% srPath = 'E:\fusion_project\dataset\CAVE\cavems';
srPath = 'H:\fusion_project\dataset\CAVE\CAVEori\testori';
